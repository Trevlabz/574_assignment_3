...
HD_PWD='C:/Users/trevl/Documents/GitHub/Assignment3/testing/assignment3_test/assignment3_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HLSM11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HLSM11.tcl
