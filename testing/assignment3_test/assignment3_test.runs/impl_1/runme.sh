...
HD_PWD='C:/Users/trevl/Documents/GitHub/Assignment3/testing/assignment3_test/assignment3_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HLSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HLSM.tcl -notrace
